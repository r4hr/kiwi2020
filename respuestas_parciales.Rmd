---
title: "Respuestas Parciales Encuesta KIWI de Sueldos de RRHH de LATAM"
...
### El tiempo aproximado para completarla es de 6'52" `#chequeadísimo` `r emo::ji("switzerland")`
...
Recibimos un total de `r nrow(kiwi)` respuestas `r emo::ji("party")`:trophy:.
...
Al respecto quisimos saber a cuántas mujeres y hombres les habían hecho preguntas desubicadas sobre si tendrían hijos, o si tenían planes de casamiento. En `r nrow(listado_preg)` respuestas esto es lo que encontramos:
